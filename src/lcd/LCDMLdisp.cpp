...
LCDML_add(2, LCDML_0_2, 1, "Functions", NULL);
LCDML_addAdvanced(3, LCDML_0_2, 2, COND_hide, "1", mFunc_settings, 0, _LCDML_TYPE_default);
LCDML_add(4, LCDML_0_2_1, 1, "Current function", mFunc_Functions);
LCDML_add(5, LCDML_0_2_1, 2, "Filling", NULL);
LCDML_addAdvanced(6, LCDML_0_2_1_2, 1, NULL, "High point", mFunc_highSetpoint, settings.setPointHigh, _LCDML_TYPE_default);
LCDML_addAdvanced(7, LCDML_0_2_1_2, 2, NULL, "Low point", mFunc_lowSetpoint, settings.setPointLow, _LCDML_TYPE_default);
LCDML_addAdvanced(8, LCDML_0_2_1_2, 3, NULL, "Hysteresis", mFunc_hysteresis, settings.Hysteresis, _LCDML_TYPE_default);
LCDML_add(9, LCDML_0_2_1, 3, "Dosing", NULL);
LCDML_addAdvanced(10, LCDML_0_2_1_3, 1, NULL, "Test feed", mFunc_testFeed, settings.setPointHigh, _LCDML_TYPE_default);
LCDML_addAdvanced(11, LCDML_0_2_1_3, 2, NULL, "High time", mFunc_dosingHighTime, settings.dosingFunction.highTime, _LCDML_TYPE_default);
LCDML_addAdvanced(12, LCDML_0_2_1_3, 3, NULL, "Low time", mFunc_dosingLowTime, settings.setPointLow, _LCDML_TYPE_default);
LCDML_addAdvanced(13, LCDML_0_2_1_3, 4, NULL, "Cycle count", mFunc_dosingCycleCount, settings.Hysteresis, _LCDML_TYPE_default);
LCDML_addAdvanced(14, LCDML_0_2_1_3, 5, NULL, "Last time", mfunc_lastTime, settings.dosingFunction.lastTime, _LCDML_TYPE_default);
LCDML_addAdvanced(15, LCDML_0_2_1_3, 6, NULL, "Output number pin", mFunc_dosingOutputNumber, settings.Hysteresis, _LCDML_TYPE_default);
LCDML_add(16, LCDML_0_2, 3, "Scale", mFunc_scale);
LCDML_addAdvanced(17, LCDML_0_2, 4, NULL, "Unit", mFunc_unit, 1, _LCDML_TYPE_default);
LCDML_addAdvanced(18, LCDML_0_2, 5, NULL, "Ratio", mFunc_ratio, settings.ratio, _LCDML_TYPE_default);
LCDML_addAdvanced(19, LCDML_0_2, 6, NULL, "Coefficent", mFunc_coefficent, settings.unit, _LCDML_TYPE_default);
LCDML_add(20, LCDML_0_2, 7, "Tare", mFunc_tare);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      if (currentNumberFunction == 0)
        currentNumberFunction = 1;
      else
        currentNumberFunction = 0;
    }
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      if (currentNumberdosingOutput == 0)
        currentNumberdosingOutput = 1;
      else
        currentNumberdosingOutput = 0;
    }
    if (LCDML.BT_checkQuit())
    {
      LCDML.FUNC_goBackToMenu(3);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      ...
      if (currentNumberlastTime == 0)
        currentNumberlastTime = 30;
    }
    if (LCDML.BT_checkQuit())
    {
      LCDML.FUNC_goBackToMenu(3);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      ...
      if (currentNumberAvgCount == 0)
        currentNumberAvgCount = 15;
    }
    if (LCDML.BT_checkQuit())
    {
      LCDML.FUNC_goBackToMenu(3);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      ...
      if (currentNumberZeroFilter == 0)
        currentNumberZeroFilter = 15;
    }
    if (LCDML.BT_checkQuit())
    {
      LCDML.FUNC_goBackToMenu(3);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_setup()) // ****** SETUP *********
  {
    if (settings.startupTare)
      currentNumberStartupTare = 1;
    else
      currentNumberStartupTare = 0;
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    ...
    do
    {
      ...
      {
        if (currentNumberStartupTare == 1)
          settings.startupTare = true;
        else
          settings.startupTare = false;
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkDown())
    {
      if (currentNumberdeadTare == 0)
        currentNumberdeadTare = 1;
      else
        currentNumberdeadTare = 0;
    }
    if (LCDML.BT_checkQuit())
    {
      LCDML.FUNC_goBackToMenu(3);
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberpassword == 3)
        currentNumberpassword = 1;
      else
        currentNumberpassword++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberpassword1 == 0)
          numberpassword1 = 9;
        else
          numberpassword1--;
        break;
      case 2:
        if (numberpassword2 == 0)
          numberpassword2 = 9;
        else
          numberpassword2--;
        break;
      case 3:
        if (numberpassword3 == 0)
          numberpassword3 = 9;
        else
          numberpassword3--;
        break;
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentdosingCycleCount == 3)
        currentdosingCycleCount = 1;
      else
        currentdosingCycleCount++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberdosingCycleCount1 == 0)
          numberdosingCycleCount1 = 9;
        else
          numberdosingCycleCount1--;
        break;
      case 2:
        if (numberdosingCycleCount2 == 0)
          numberdosingCycleCount2 = 9;
        else
          numberdosingCycleCount2--;
        break;
      case 3:
        if (numberdosingCycleCount3 == 0)
          numberdosingCycleCount3 = 9;
        else
          numberdosingCycleCount3--;
        break;
      }
    }
    if (LCDML.BT_checkQuit())
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberDosingHighTime == 5)
        currentNumberDosingHighTime = 1;
      else
        currentNumberDosingHighTime++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberdosingHighTime1 == 0)
          numberdosingHighTime1 = 9;
        else
          numberdosingHighTime1--;
        break;
      case 2:
        if (numberdosingHighTime2 == 0)
          numberdosingHighTime2 = 9;
        else
          numberdosingHighTime2--;
        break;
      case 3:
        if (numberdosingHighTime3 == 0)
          numberdosingHighTime3 = 9;
        else
          numberdosingHighTime3--;
        break;
      case 4:
        if (numberdosingHighTime4 == 0)
          numberdosingHighTime4 = 9;
        else
          numberdosingHighTime4--;
        break;
      case 5:
        if (numberdosingHighTime5 == 0)
          numberdosingHighTime5 = 9;
        else
          numberdosingHighTime5--;
        break;
      }
    }
    if (LCDML.BT_checkQuit())
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberDosingLowTime == 5)
        currentNumberDosingLowTime = 1;
      else
        currentNumberDosingLowTime++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberdosingLowTime1 == 0)
          numberdosingLowTime1 = 9;
        else
          numberdosingLowTime1--;
        break;
      case 2:
        if (numberdosingLowTime2 == 0)
          numberdosingLowTime2 = 9;
        else
          numberdosingLowTime2--;
        break;
      case 3:
        if (numberdosingLowTime3 == 0)
          numberdosingLowTime3 = 9;
        else
          numberdosingLowTime3--;
        break;
      case 4:
        if (numberdosingLowTime4 == 0)
          numberdosingLowTime4 = 9;
        else
          numberdosingLowTime4--;
        break;
      case 5:
        if (numberdosingLowTime5 == 0)
          numberdosingLowTime5 = 9;
        else
          numberdosingLowTime5--;
        break;
      }
    }
    if (LCDML.BT_checkQuit())
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberSetpointHigh == 4)
        currentNumberSetpointHigh = 1;
      else
        currentNumberSetpointHigh++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberSetpointHigh1 == 0)
          numberSetpointHigh1 = 9;
        else
          numberSetpointHigh1--;
        break;
      case 2:
        if (numberSetpointHigh2 == 0)
          numberSetpointHigh2 = 9;
        else
          numberSetpointHigh2--;
        break;
      case 3:
        if (numberSetpointHigh3 == 0)
          numberSetpointHigh3 = 9;
        else
          numberSetpointHigh3--;
        break;
      case 4:
        if (numberSetpointHigh4 == 0)
          numberSetpointHigh4 = 9;
        else
          numberSetpointHigh4--;
        break;
      }
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberSetpointLow == 4)
        currentNumberSetpointLow = 1;
      else
        currentNumberSetpointLow++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberSetpointLow1 == 0)
          numberSetpointLow1 = 9;
        else
          numberSetpointLow1--;
        break;
      case 2:
        if (numberSetpointLow2 == 0)
          numberSetpointLow2 = 9;
        else
          numberSetpointLow2--;
        break;
      case 3:
        if (numberSetpointLow3 == 0)
          numberSetpointLow3 = 9;
        else
          numberSetpointLow3--;
        break;
      case 4:
        if (numberSetpointLow4 == 0)
          numberSetpointLow4 = 9;
        else
          numberSetpointLow4--;
        break;
      }
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumbernumberhysteresis == 3)
        currentNumbernumberhysteresis = 1;
      else
        currentNumbernumberhysteresis++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numberhysteresis1 == 0)
          numberhysteresis1 = 9;
        else
          numberhysteresis1--;
        break;
      case 2:
        if (numberhysteresis2 == 0)
          numberhysteresis2 = 9;
        else
          numberhysteresis2--;
        break;
      case 3:
        if (numberhysteresis3 == 0)
          numberhysteresis3 = 9;
        else
          numberhysteresis3--;
        break;
...
// *********************************************************************
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    if (LCDML.BT_checkUp())
    {
      if (currentNumberCoefficent == 6)
        currentNumberCoefficent = 1;
      else
        currentNumberCoefficent++;
    }
    if (LCDML.BT_checkDown())
    {
      ...
      {
      case 1:
        if (numbercoefficent1 == 0)
          numbercoefficent1 = 9;
        else
          numbercoefficent1--;
        break;
      case 2:
        if (numbercoefficent2 == 0)
          numbercoefficent2 = 9;
        else
          numbercoefficent2--;
        break;
      case 3:
        if (numbercoefficent3 == 0)
          numbercoefficent3 = 9;
        else
          numbercoefficent3--;
        break;
      case 4:
        if (numbercoefficent4 == 0)
          numbercoefficent4 = 9;
        else
          numbercoefficent4--;
        break;
      case 5:
        if (numbercoefficent5 == 0)
          numbercoefficent5 = 9;
        else
          numbercoefficent5--;
        break;
      case 6:
        if (numbercoefficent6 == 0)
          numbercoefficent6 = 9;
        else
          numbercoefficent6--;
        break;
...
void mFunc_settingsPassword(uint8_t param)
{
  ...
  if (LCDML.FUNC_loop()) // ****** LOOP *********
  {
    ...
    {
      passwordWrong = "";
      if (currentNumberSettingsPassword == 3)
        currentNumberSettingsPassword = 1;
      else
        currentNumberSettingsPassword++;
    }
    if (LCDML.BT_checkDown())
    {
      passwordWrong = "";
      ...
      {
      case 1:
        if (numberSettingsPassword1 == 0)
          numberSettingsPassword1 = 9;
        else
          numberSettingsPassword1--;
        break;
      case 2:
        if (numberSettingsPassword2 == 0)
          numberSettingsPassword2 = 9;
        else
          numberSettingsPassword2--;
        break;
      case 3:
        if (numberSettingsPassword3 == 0)
          numberSettingsPassword3 = 9;
        else
          numberSettingsPassword3--;
        break;
      }
    }
    if (LCDML.BT_checkQuit())
    ...
    do
    {
      ...
      if (functions.functionActive)
      {
        if (settings.currentFunction == 0)
          u8g2.drawStr(1, 26, String("F").c_str());
        else
          u8g2.drawStr(1, 26, String("D").c_str());
      }
      else
        u8g2.drawStr(1, 23, String("").c_str());
      ...
      if (inputs.input1 == 0)
      {
        u8g2.drawDisc(20, 8, 4);
      }
      else
      {
        u8g2.drawCircle(20, 8, 4);
      }
      if (inputs.input2 == 0)
      {
        u8g2.drawDisc(50, 8, 4);
      }
      else
      {
        u8g2.drawCircle(50, 8, 4);
      }
      ...
      case 0:
      {
        ...
        if (functions.highSetPoint)
          u8g2.drawBox(119, 4, 8, 8);
        else
          u8g2.drawFrame(119, 4, 8, 8);
        if (functions.lowSetPoint)
          u8g2.drawBox(89, 4, 8, 8);
        else
